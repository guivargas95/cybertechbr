...
export default function HighLightsArticles(props: any) {
    ...
    return (
        <section>
            ...
            <div className="w-11/12 flex flex-col items-center content-center mr-auto ml-auto justify-center md:grid md:grid-cols-2 md:w-140">
                {articleList?.map(response => {
                    return (
                        <div className="w-80 mt-3 mb-3 md:mt-1 md:mb-1 shadow-sm shadow-black md:mr-auto md:ml-auto md:h-112" key={response.id}>
